...
class ClientNet(QWidget, Ui_GameBoard):
	...
	self.boardgame.gameLobby.show()
        ...
        self.boardgame.clicked.connect(self.displayCharacterSelection)
	...
	self.boardgame.scarlett.clicked.connect(self.selectCharacter("scarlett")
	self.boardgame.mustard.clicked.connect(self.selectCharacter("mustard"))
	self.boardgame.white.clicked.connect(self.selectCharacter("white"))
	self.boardgame.green.clicked.connect(self.selectCharacter("green"))
	self.boardgame.peacock.clicked.connect(self.selectCharacter("peacock"))
	self.boardgame.plum.clicked.connect(self.selectCharacter("plum"))
