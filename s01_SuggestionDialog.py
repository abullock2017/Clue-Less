...
# Form implementation generated from reading ui file 'D:\Documents\eclipse-oxygen-workspace\Clue-Less\s01_SuggestionDialog.ui'
#
...
class Ui_SuggestionDialog(object):
    def setupUi(self, SuggestionDialog):
        ...
        self.roomSuggestion.setEnabled(False)
        self.roomSuggestion.setGeometry(QtCore.QRect(70, 180, 261, 31))
        self.roomSuggestion.setEditable(False)
